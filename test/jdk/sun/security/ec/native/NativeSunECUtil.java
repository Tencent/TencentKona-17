...
public class NativeSunECUtil {
    ...
    private static boolean nativeSunECSupported() {
        ...
        Path suneccryptoMacPath = jdkLibDir.resolve("libsuneccrypto.dylib");
        return Files.exists(suneccryptoLinuxPath) || Files.exists(suneccryptoMacPath);
    }
