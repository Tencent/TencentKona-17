...
public class SM4ParametersTest {
    ...
    public void testEncode() throws Exception {
        ...
        assertArrayEquals(ENCODED_PARAMS, encodedParams);
        ...
        assertArrayEquals(GCM_ENCODED_PARAMS, encodedParams);
    }
    ...
    public void testDecode() throws Exception {
        ...
        assertArrayEquals(IV, decodedParams.getIV());
        ...
        assertArrayEquals(GCM_IV, decodedGcmParams.getIV());
    }
