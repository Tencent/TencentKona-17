    ...
    public static void main(String[] args) throws Throwable {
        ...
        for (RecordedEvent event : events) {
            ...
            if (ALLOC_EVENT_NAME.equals(event.getEventType().getName())) {
                ...
                long allocationSize = Events.assertField(event, "allocationSize").atLeast(100L).getValue();
                // Unsafe.allocateMemory aligns bytes to heap word size, exactly 8 on 64-bit platforms.
                // The allocated size is 104, not 100, since the former is a multiple of 8.
                assertEquals(allocationSize, 104L);
                ...
                long allocationSize = Events.assertField(event, "allocationSize").atLeast(1000L).getValue();
