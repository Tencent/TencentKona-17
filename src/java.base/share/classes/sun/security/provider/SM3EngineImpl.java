 ...
 */
public final class SM3EngineImpl implements SM3Engine {
    ...
    public SM3EngineImpl clone() throws CloneNotSupportedException {
        SM3EngineImpl clone = (SM3EngineImpl) super.clone();
        clone.v = v.clone();
        clone.w = w.clone();
